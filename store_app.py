    ...
    if login_mode:
        ...
        <style>
            ...
            .main .block-container { 
                ...
                justify-content: center; height: 95vh; padding: 0 !important; max-width: 100%; 
            }
...
def get_client():
    try:
        # Load secrets into a standard dictionary to fix key issues
        creds_dict = dict(st.secrets["gcp_service_account"])
        
        # 🔧 AUTO-REPAIR: Fix Private Key Formatting
        if "private_key" in creds_dict:
            raw_key = creds_dict["private_key"]
            # Fix keys that have literal "\n" strings instead of actual newlines
