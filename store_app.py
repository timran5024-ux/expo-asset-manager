...
# ==========================================
# 1. PROFESSIONAL THEME & SHADOW-BOX CSS
# ==========================================
...
if os.path.exists("logo.png"):
    ...
    <style>
        ...
        .stApp::before {{
            ...
            background-color: rgba(255, 255, 255, 0.94); z-index: -1;
        }}
        
        /* 1. FORCE WHITE TEXT ON BLACK BUTTONS */
        div.stButton > button {{
        ...
        /* 2. MODERN INPUT BOXES WITH PADDING */
        ...
        /* 3. PROFESSIONAL WHITE CARDS (Prevents background interference) */
        ...
        .centered-title {{
            ...
            color: #111111; margin-bottom: 40px; text-transform: uppercase;
        }}
    </style>
...
if not st.session_state['logged_in']:
    ...
    with mid:
        tab_log = st.tabs(["🔒 TECHNICIAN", "🛡️ ADMINISTRATOR"])
        with tab_log[0]:
...
# ==========================================
    ...
    if nav == "DASHBOARD":
        st.subheader("Inventory Metrics Overview")
        if not df.empty:
            ...
            for i, model in enumerate(models):
                ...
                with cols[i % 3]:
                    ...
                    fig = px.pie(sub, names='CONDITION', hole=0.5, color_discrete_sequence=px.colors.qualitative.Bold)
        ...
        with t_ctrl[1]:
            s_sn = st.text_input("Serial to Modify")
            if s_sn:
        ...
        with t_ctrl[2]:
            d_sn = st.text_input("Serial to Remove")
        ...
        st.subheader("Full Inventory Records")
